...
const DEFAULT_ITEMS: CarouselItem[] = [
  { title: "Strategy & Positioning", id: 1 },
  { title: "Content Creation", id: 2 },
  { title: "Profile Setup & Optimization", id: 3 },
  { title: "Scheduling & Distribution", id: 4 },
  { title: "Community Management", id: 5 },
  { title: "Paid Advertising", id: 6 },
  { title: "Influencer & UGC Collaboration", id: 7 },
  { title: "Analytics & Reporting", id: 8 },
];
...
export default function SocalMediaManagementCarousel({
  items = DEFAULT_ITEMS,
  baseWidth = 300,
  autoplay = false,
  autoplayDelay = 3000,
