...
const DEFAULT_ITEMS: CarouselItem[] = [
  { title: "Google Advertisement", id: 1 },
  { title: "Meta Advertisement", id: 2 },
  { title: "Social Media Marketing", id: 3 },
  { title: "Email Marketing", id: 4 },
  { title: "Search Engine Optimisation (SEO)", id: 5 },
  { title: "Affiliate Marketing", id: 6 },
  { title: "Content Marketing", id: 7 },
  { title: "Influencer Marketing", id: 8 },
];
...
export default function DigitalMarketingCarousel({
  items = DEFAULT_ITEMS,
  baseWidth = 300,
  autoplay = false,
  autoplayDelay = 3000,
