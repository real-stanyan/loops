...
const DEFAULT_ITEMS: CarouselItem[] = [
  { title: "Professional Copy-writing", id: 1 },
  { title: "Videography", id: 2 },
  { title: "Photography", id: 3 },
  { title: "Press Releases", id: 4 },
  { title: "Product Descriptions", id: 5 },
  { title: "Case Studies", id: 6 },
  { title: "Interactive Content", id: 7 },
  { title: "Photo & Video Editing", id: 8 },
];
...
export default function ContentCreationCarousel({
  items = DEFAULT_ITEMS,
  baseWidth = 300,
  autoplay = false,
  autoplayDelay = 3000,
