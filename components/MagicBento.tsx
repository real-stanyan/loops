...
const cardData: BentoCardProps[] = [
  {
    color: "#ffffff0d",
    title: "Social & Web Content",
    description: "Photo, video, graphics, and copy that fit your brand.",
    label: "Content Creation",
  },
  {
    color: "#ffffff0d",
    title: "SEO • Ads • Email",
    description: "Data-driven SEO, ads, and email to grow revenue.",
    label: "Digital Marketing",
  },
  {
    color: "#ffffff0d",
    title: "Visual Identity, UI/UX & Website Build",
    description: "Graphic Design and Web Developing",
    label: "Design & Dev",
  },
  {
    color: "#ffffff0d",
  ...
  },
  {
    ...
    description: "Find the right creators to drive traffic and sales.",
    label: "Influencer Marketing",
  },
  {
    color: "#ffffff0d",
    title: "China Market Entry & Growth",
    description: "Localised strategy for CN platforms.",
    label: "Chinese Marketing",
  },
];
