...
const Footer = () => {
  return (
    <>
      <div
        className={`
      bg-[#f5f5f7] text-[#1d1d1f] p-5 md:p-10 xl:p-20 flex justify-between items-start gap-20
      ...
      >
        ...
        <div className="flex flex-1 justify-evenly gap-4">
          ...
          <div className="space-y-3">
            <h3 className="font-black text-lg md:text-xl xl:text-2xl">
              Services
            </h3>
      ...
      <div className="bg-black text-white flex justify-between items-center px-20 py-3">
        <Link href={"/"} className="font-black">
          Privacy Policy
        </Link>
        <h3>© Copyright Loops Design Studio 2025</h3>
      </div>
    </>
  );
};
